...
mod tests {
    ...
    fn claude_status_colors_match_the_devez_code_script() {
        let expected = [
            (ThemeKind::Minimal, [Rgb(0x00, 0xD1, 0xD1), Rgb(0xCA, 0x8A, 0x04), Rgb(0xD1, 0x00, 0x00), Rgb(0xB5, 0x00, 0xD1)], [Rgb(0xD1, 0x9F, 0x00), Rgb(0x00, 0xA7, 0x40), Rgb(0x43, 0x38, 0xCA), Rgb(0x7C, 0x00, 0xD1), Rgb(0xD1, 0x00, 0x00)]),
            (ThemeKind::Soft, [Rgb(0x00, 0xCC, 0xCC), Rgb(0xC9, 0x7C, 0x1A), Rgb(0xCC, 0x00, 0x00), Rgb(0xB1, 0x00, 0xCC)], [Rgb(0xCC, 0x9C, 0x00), Rgb(0x00, 0xA3, 0x3F), Rgb(0x43, 0x38, 0xCA), Rgb(0x79, 0x00, 0xCC), Rgb(0xCC, 0x00, 0x00)]),
            (ThemeKind::Dark, [Rgb(0x07, 0xDC, 0xDB), Rgb(0xD9, 0xB1, 0x17), Rgb(0xD7, 0x65, 0x64), Rgb(0xCA, 0x6C, 0xD6)], [Rgb(0xC0, 0x97, 0x14), Rgb(0x3C, 0x8A, 0x58), Rgb(0x9B, 0xA1, 0xD6), Rgb(0x9A, 0x77, 0xDB), Rgb(0xD7, 0x65, 0x64)]),
            (ThemeKind::Gray, [Rgb(0x32, 0x6A, 0xA5), Rgb(0xA1, 0x62, 0x07), Rgb(0xC2, 0x41, 0x3E), Rgb(0x76, 0x55, 0x8F)], [Rgb(0xA1, 0x62, 0x07), Rgb(0x15, 0x80, 0x3D), Rgb(0x76, 0x55, 0x8F), Rgb(0x65, 0x49, 0x7B), Rgb(0xC2, 0x41, 0x3E)]),
            (ThemeKind::SoftPink, [Rgb(0x32, 0x6A, 0x9F), Rgb(0x9A, 0x65, 0x0B), Rgb(0xC2, 0x41, 0x3E), Rgb(0x84, 0x58, 0x8F)], [Rgb(0x9A, 0x65, 0x0B), Rgb(0x25, 0x72, 0x3C), Rgb(0x84, 0x58, 0x8F), Rgb(0x70, 0x46, 0x7E), Rgb(0xC2, 0x41, 0x3E)]),
            (ThemeKind::Midnight, [Rgb(0x07, 0xDC, 0xDB), Rgb(0xD9, 0xB1, 0x17), Rgb(0xD7, 0x65, 0x64), Rgb(0xCA, 0x6C, 0xD6)], [Rgb(0xC0, 0x97, 0x14), Rgb(0x3C, 0x8A, 0x58), Rgb(0x9B, 0xA1, 0xD6), Rgb(0x9A, 0x77, 0xDB), Rgb(0xD7, 0x65, 0x64)]),
        ];

        for (theme, models, efforts) in expected {
            let status = palette_of(theme).status;
            assert_eq!([status.model_haiku, status.model_sonnet, status.model_opus, status.model_fable], models);
            assert_eq!([status.effort_low, status.effort_medium, status.effort_high, status.effort_xhigh, status.effort_max], efforts);
        }
    }
