...
pub const MINIMAL: ThemePalette = ThemePalette {
    ...
    diff_add_bg: Rgb(0xC9, 0xED, 0xD3),
    diff_remove_bg: Rgb(0xF8, 0xD1, 0xD6),
    diff_add_word_bg: Rgb(0x8A, 0xD9, 0x9F),
    diff_remove_word_bg: Rgb(0xF2, 0x97, 0xA1),
...
pub const SOFT: ThemePalette = ThemePalette {
    ...
    diff_add_bg: Rgb(0xCD, 0xE4, 0xC9),
    diff_remove_bg: Rgb(0xF2, 0xCE, 0xCE),
    diff_add_word_bg: Rgb(0x7F, 0xB7, 0x6A),
    diff_remove_word_bg: Rgb(0xE8, 0x92, 0x92),
...
pub const DARK: ThemePalette = ThemePalette {
    ...
    diff_add_bg: Rgb(0x16, 0x3D, 0x22),
    diff_remove_bg: Rgb(0x4B, 0x1F, 0x1E),
    diff_add_word_bg: Rgb(0x1F, 0x6B, 0x38),
    diff_remove_word_bg: Rgb(0x93, 0x2F, 0x2C),
...
pub const GRAY: ThemePalette = ThemePalette {
    ...
    diff_add_bg: Rgb(0xD2, 0xEF, 0xDA),
    diff_remove_bg: Rgb(0xFA, 0xD7, 0xD7),
    diff_add_word_bg: Rgb(0x8A, 0xD9, 0x9F),
    diff_remove_word_bg: Rgb(0xF1, 0x99, 0xA1),
...
pub const SOFT_PINK: ThemePalette = ThemePalette {
    ...
    diff_add_bg: Rgb(0xD6, 0xEF, 0xDD),
    diff_remove_bg: Rgb(0xFB, 0xD8, 0xDC),
    diff_add_word_bg: Rgb(0x8E, 0xD5, 0xA3),
    diff_remove_word_bg: Rgb(0xF2, 0x9E, 0xA8),
...
pub const MIDNIGHT: ThemePalette = ThemePalette {
    ...
    syntax_attribute: Rgb(0xC5, 0x86, 0xC0),
    syntax_property: Rgb(0x9C, 0xDC, 0xFE),
    diff_add_bg: Rgb(0x12, 0x3C, 0x28),
    diff_remove_bg: Rgb(0x4A, 0x1E, 0x28),
    diff_add_word_bg: Rgb(0x1C, 0x68, 0x40),
    diff_remove_word_bg: Rgb(0x8E, 0x2F, 0x3E),
